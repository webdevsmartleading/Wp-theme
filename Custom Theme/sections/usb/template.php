...
>
    <div class="sls-container">
        <div class="sls-usb__intro-grid">
            ...
            <div class="sls-usb__media">
                <?php if ($has_image) : ?>
                    <?php sls_render_attachment_image($settings['image'], $settings['image_alt'], 'large', 'sls-usb__image'); ?>
                <?php else : ?>
                    <?php sls_render_placeholder_visual(__('USB image placeholder', 'sls-theme')); ?>
                <?php endif; ?>
            </div>
        </div>
